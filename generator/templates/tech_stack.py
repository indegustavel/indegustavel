"""SVG template: Focus Sectors radar (dynamic height)."""
...
def render(
    ...
    """
    # Focus Sectors radar only (centered)
    ...
    # Radar geometry - centered in the card
    radius = 65
    rcx = WIDTH // 2  # center horizontally
    badge_start_y = 65
  ...
  <!-- Focus Sectors -->
  <text x="{WIDTH // 2}" y="38" fill="{theme['text_faint']}" font-size="11" font-family="monospace" letter-spacing="3" text-anchor="middle">FOCUS SECTORS</text>
